...
use Emploi\EmploiBundle\Entity\Eleve;
...
class EleveController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $eleves = $em->getRepository('EmploiBundle:Eleve')->findAll();
    ...
    {
        $eleve = new Eleve();
        $form = $this->createForm('Emploi\EmploiBundle\Form\EleveType', $eleve);
    ...
    {
        $deleteForm = $this->createDeleteForm($eleve);
        $editForm = $this->createForm('Emploi\EmploiBundle\Form\EleveType', $eleve);
