...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('6J8pEt4G-f', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('E7Ylxb7qHh', 0, 'uLCdYkJ-DeT3hyLhsAMeXi', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YFa8igmWig', 0, 'uLCdYkJ-DeT3hyLhsAMeXi', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'emploi2', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $d, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_0000000018d14131000000001e16d395cfa5559ad455291b954fccefcb013630(
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7ccd832002defcde7be9fb2f2395cf7fbd75111a8cb83775ddfe04b6f2c638aa');
    ...
    public function getFosUser_UserManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['fos_user.user_manager'] = new FOSUserBundleDoctrineUserManager_0000000018d14462000000001e16d395cfa5559ad455291b954fccefcb013630(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MO-R3aEIhu', 0, 'uLCdYkJ-DeT3hyLhsAMeXi', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'validator.mapping.cache.prefix' => 'validator_ea65a5942e451dcdec89d448945a95ddff427a8d2352d8162c25340ab8f8998e',
...
class DoctrineORMEntityManager_0000000018d14131000000001e16d395cfa5559ad455291b954fccefcb013630 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder58e136868a419705194885 = null;
    private $initializer58e136868a4d7008859507 = null;
    private static $publicProperties58e136868a2bc479873391 = array(
        
    );
    public function getConnection()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getConnection', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getMetadataFactory', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getExpressionBuilder', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'beginTransaction', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getCache', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getCache();
    }
    public function transactional($func)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'transactional', array('func' => $func), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->transactional($func);
    }
    public function commit()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'commit', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->commit();
    }
    public function rollback()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'rollback', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getClassMetadata', array('className' => $className), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'createQuery', array('dql' => $dql), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'createNamedQuery', array('name' => $name), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'createQueryBuilder', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'flush', array('entity' => $entity), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->flush($entity);
    }
    public function find($entityName, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'clear', array('entityName' => $entityName), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->clear($entityName);
    }
    public function close()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'close', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->close();
    }
    public function persist($entity)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'persist', array('entity' => $entity), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'remove', array('entity' => $entity), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'refresh', array('entity' => $entity), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'detach', array('entity' => $entity), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'merge', array('entity' => $entity), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getRepository', array('entityName' => $entityName), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'contains', array('entity' => $entity), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getEventManager', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getConfiguration', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'isOpen', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getUnitOfWork', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getProxyFactory', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'initializeObject', array('obj' => $obj), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'getFilters', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'isFiltersStateClean', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'hasFilters', array(), $this->initializer58e136868a4d7008859507);
        return $this->valueHolder58e136868a419705194885->hasFilters();
    }
    public function __construct($initializer)
    {
        $this->initializer58e136868a4d7008859507 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, '__get', array('name' => $name), $this->initializer58e136868a4d7008859507);
        if (isset(self::$publicProperties58e136868a2bc479873391[$name])) {
            return $this->valueHolder58e136868a419705194885->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58e136868a419705194885;
    ...
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58e136868a4d7008859507);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58e136868a419705194885;
    ...
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, '__isset', array('name' => $name), $this->initializer58e136868a4d7008859507);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58e136868a419705194885;
    ...
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, '__unset', array('name' => $name), $this->initializer58e136868a4d7008859507);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58e136868a419705194885;
    ...
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, '__clone', array(), $this->initializer58e136868a4d7008859507);
        $this->valueHolder58e136868a419705194885 = clone $this->valueHolder58e136868a419705194885;
    }
    public function __sleep()
    {
        $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, '__sleep', array(), $this->initializer58e136868a4d7008859507);
        return array('valueHolder58e136868a419705194885');
    }
    ...
    {
        return $this->initializer58e136868a4d7008859507;
    }
    public function initializeProxy()
    {
        return $this->initializer58e136868a4d7008859507 && $this->initializer58e136868a4d7008859507->__invoke($this->valueHolder58e136868a419705194885, $this, 'initializeProxy', array(), $this->initializer58e136868a4d7008859507);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder58e136868a419705194885;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder58e136868a419705194885;
    }
}

class FOSUserBundleDoctrineUserManager_0000000018d14462000000001e16d395cfa5559ad455291b954fccefcb013630 extends \FOS\UserBundle\Doctrine\UserManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder58e136875a3ad786581879 = null;
    private $initializer58e136875a46c215374230 = null;
    private static $publicProperties58e136875a24d388365174 = array(
        
    );
    public function deleteUser(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'deleteUser', array('user' => $user), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->deleteUser($user);
    }
    public function getClass()
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'getClass', array(), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->getClass();
    }
    public function findUserBy(array $criteria)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'findUserBy', array('criteria' => $criteria), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->findUserBy($criteria);
    }
    public function findUsers()
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'findUsers', array(), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->findUsers();
    }
    public function reloadUser(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'reloadUser', array('user' => $user), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->reloadUser($user);
    }
    public function updateUser(\FOS\UserBundle\Model\UserInterface $user, $andFlush = true)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'updateUser', array('user' => $user, 'andFlush' => $andFlush), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->updateUser($user, $andFlush);
    }
    public function createUser()
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'createUser', array(), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->createUser();
    }
    public function findUserByEmail($email)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'findUserByEmail', array('email' => $email), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->findUserByEmail($email);
    }
    public function findUserByUsername($username)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'findUserByUsername', array('username' => $username), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->findUserByUsername($username);
    }
    public function findUserByUsernameOrEmail($usernameOrEmail)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'findUserByUsernameOrEmail', array('usernameOrEmail' => $usernameOrEmail), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->findUserByUsernameOrEmail($usernameOrEmail);
    }
    public function findUserByConfirmationToken($token)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'findUserByConfirmationToken', array('token' => $token), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->findUserByConfirmationToken($token);
    }
    public function updateCanonicalFields(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'updateCanonicalFields', array('user' => $user), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->updateCanonicalFields($user);
    }
    public function updatePassword(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'updatePassword', array('user' => $user), $this->initializer58e136875a46c215374230);
        return $this->valueHolder58e136875a3ad786581879->updatePassword($user);
    }
    public function __construct($initializer)
    {
        $this->initializer58e136875a46c215374230 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, '__get', array('name' => $name), $this->initializer58e136875a46c215374230);
        if (isset(self::$publicProperties58e136875a24d388365174[$name])) {
            return $this->valueHolder58e136875a3ad786581879->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58e136875a3ad786581879;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58e136875a46c215374230);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58e136875a3ad786581879;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, '__isset', array('name' => $name), $this->initializer58e136875a46c215374230);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58e136875a3ad786581879;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, '__unset', array('name' => $name), $this->initializer58e136875a46c215374230);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58e136875a3ad786581879;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, '__clone', array(), $this->initializer58e136875a46c215374230);
        $this->valueHolder58e136875a3ad786581879 = clone $this->valueHolder58e136875a3ad786581879;
    }
    public function __sleep()
    {
        $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, '__sleep', array(), $this->initializer58e136875a46c215374230);
        return array('valueHolder58e136875a3ad786581879');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer58e136875a46c215374230;
    }
    public function initializeProxy()
    {
        return $this->initializer58e136875a46c215374230 && $this->initializer58e136875a46c215374230->__invoke($this->valueHolder58e136875a3ad786581879, $this, 'initializeProxy', array(), $this->initializer58e136875a46c215374230);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder58e136875a3ad786581879;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder58e136875a3ad786581879;
    }
}
