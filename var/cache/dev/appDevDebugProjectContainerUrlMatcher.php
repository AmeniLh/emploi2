...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/creer')) {
            // creerAnnee
            if ($pathinfo === '/creerAnnee') {
                return array (  '_controller' => 'Emploi\\EmploiBundle\\Controller\\DefaultController::creerAnneeAction',  '_route' => 'creerAnnee',);
            }

            // creerClasse
            if ($pathinfo === '/creerClasse') {
                return array (  '_controller' => 'Emploi\\EmploiBundle\\Controller\\DefaultController::creerClasseAction',  '_route' => 'creerClasse',);
            }

        }

        if (0 === strpos($pathinfo, '/gestionE')) {
            // gestionEleve
            if ($pathinfo === '/gestionEleve') {
                return array (  '_controller' => 'Emploi\\EmploiBundle\\Controller\\DefaultController::gestionEleveAction',  '_route' => 'gestionEleve',);
            }

            // gestionEnseignant
            if ($pathinfo === '/gestionEnseignant') {
                return array (  '_controller' => 'Emploi\\EmploiBundle\\Controller\\DefaultController::gestionEnseignantAction',  '_route' => 'gestionEnseignant',);
            }

            // gestionEmploiStatique
            if ($pathinfo === '/gestionEmploiStat') {
                return array (  '_controller' => 'Emploi\\EmploiBundle\\Controller\\DefaultController::gestionEmploiStatAction',  '_route' => 'gestionEmploiStatique',);
            }

        }

        // sidebarAdmin
        if ($pathinfo === '/sidebarAdmin') {
            return array (  '_controller' => 'Emploi\\EmploiBundle\\Controller\\DefaultController::sidebarAdminAction',  '_route' => 'sidebarAdmin',);
        }

        // indexAdmin
        if ($pathinfo === '/indexAdmin') {
            return array (  '_controller' => 'Emploi\\EmploiBundle\\Controller\\DefaultController::indexAdminAction',  '_route' => 'indexAdmin',);
        }
